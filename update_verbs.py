...
def fix_is_verb_false_verbs():
  verbs = Word.objects.filter(is_verb=False).exclude(conjugations=None)
  for v in verbs:
    generate_ex_for_verb(v)

def generate_ex_for_verb(verb):
