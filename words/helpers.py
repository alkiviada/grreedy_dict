...
def scrape_wordref_words(words_string, split=1):
  ...
  words_string = re.sub(
    r'(?<!^)\b(nm|nf|viintransitiv|vtr|v rif|v pron|loc |v(i)?( tr|pres)?$|agg|adj|nnoun|npl|v expr|interj|adv|avv| contraction|expr|abbr|vi +|n as|prepp|conjc|cong|idiom$|pronpron|prep +|viverbe).*', 
    '', words_string)
  if not split:
