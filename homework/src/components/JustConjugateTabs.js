...
const svgProps = { 'transform': 'scale(1.28,-1.28) translate(0 -100)',
  'viewBox': '0 88 496 30',
  'fillRule': 'evenodd',
  'fill': '#ede4d3ed',
}
  ...
  render() {
    ...
    return ( 
     <div className="just-conjugate">
      <ScallopedSVG { ...svgProps } className="scalloped-paper1" />
      <ScallopedSVG { ...svgProps } className="scalloped-paper2" />
      <ScallopedSVG { ...svgProps } className="scalloped-paper3" />
